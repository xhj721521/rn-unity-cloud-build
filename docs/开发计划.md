...
- 2025-11-04：调整首页卡片与指挥中心光效，收紧背景雾化与噪点，修复卡片内部虚框问题并统一拟物层次。
...
- 2025-11-04：落地斜框主题组件（TiltFrame/NeonButton/BottomNav），重写首页为倾斜卡布局并新增 BlindBoxScreen 承载 Unity 盲盒全屏流程。
...
- 2025-11-04����ҳ��Ƭ����Ϊ SVG ƽ���ı��Σ�ParallelogramPanel�����ʲ�/����/ä�п�������б�߲��̶������� 2��2 ���֡�
- 2025-11-05：完善 HomeScreen 斜框排版，放大指挥中心与盲盒舞台、统一功能卡 2×2 栅格，并为 ParallelogramPanel 与盲盒 CTA 注入呼吸 + 扫描动效。

- 2025-11-06：实现 QuickGlyph SVG 图标体系，指挥中心资源条、四卡快捷入口与底栏全面替换霓虹线稿，卡片内部新增渐变/噪点背景，文字样式统一为赛博科技风格。

[标记] 命运集市：所有改动前先查阅计划并在计划中记录变更（UTF-8，中文文案）。
