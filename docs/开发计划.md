...
> - 引入 `designTokens` 主题常量与 `NeonPressable` / `QuickGlyph` 组件，统一霓虹蒸汽波视觉语言。  
> - 重构 Home / Leaderboard / Event Mall / Profile 屏幕：文案全面中文化，资源条、快捷卡与盲盒 CTA 均压缩至一屏可视；盲盒按钮支持唤醒 Unity 场景。  
> - 修复排行榜 mock 数据与奖励文案，确保榜单标签、积分与中文显示无乱码。  
