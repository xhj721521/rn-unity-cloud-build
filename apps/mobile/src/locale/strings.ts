...
const zhCN = {
  ...
  'lb.desc.invite': '命运邀约榜：根据赛季邀请人数与贡献积分排名',
  'lb.desc.team': '命运战队榜：根据战队总积分与团队活跃度排名',
  'lb.desc.wealth': '命运秘矿榜：统计秘矿产出 / 试炼收益的累计排名',
  'lb.my.diff': '距离前一名还差 {value} 分',
  'lb.reward.top1': '命运巅峰 · TOP1-3 · 神秘盲盒×1 + Arc×300',
  'lb.reward.top2': '命运荣光 · TOP4-10 · Arc×150 + 勋章×1',
  'lb.reward.top3': '命运鼓励 · TOP11-20 · Arc×80 + 礼包×1',
  ...
  'market.filter.live': '进行中',
  'market.filter.redeem': '兑换中',
  'market.filter.upcoming': '预告',
  'market.filter.ended': '已结束',
  ...
  'market.section.ore': '矿石挂单',
  'market.section.fragment': '地图碎片挂单',
  'market.section.nft': '地图 NFT 挂单',
  ...
  'market.status.empty': '当前筛选暂无挂单',
  'market.action.buy': '买入',
  'market.action.sell_to': '卖给 TA',
  'market.action.sell': '卖出',
  'market.action.list': '浏览挂单',
  'market.action.viewAll': '浏览全部',
  'market.side.sell': '卖单',
  'market.side.buy': '求购',
  'market.label.quantity': '数量',
  'market.label.price': '价格',
  'market.label.orders': '挂单数',
  'market.label.seller': '卖家',
  'market.label.buyer': '求购方',
  'market.item.unknown': '未知物品',
  'market.desc.ore': '可交易 · 可合成 · 可锻造',
  'market.desc.fragment.personal': '个人地图碎片 · 可合成拓展',
  'market.desc.fragment.team': '团队地图碎片 · 可合成拓展',
  'market.desc.nft.personal': '个人地图 NFT · 稀有出货',
  'market.desc.nft.team': '团队地图 NFT · 稀有出货',
  ...
  'item.type.ore': '矿石',
  'item.type.shard': '地图碎片',
  'item.type.nft': '地图 NFT',
  'item.ownership.personal': '个人',
  'item.ownership.team': '团队',
  'item.ore.t1': '矿石 T1',
  'item.ore.t2': '矿石 T2',
  'item.ore.t3': '矿石 T3',
  'item.ore.t4': '矿石 T4',
  'item.ore.t5': '矿石 T5',
  'item.shard.personal.core': '个人地图碎片 · 命运核',
  'item.shard.personal.neon': '个人地图碎片 · 霓虹洞',
  'item.shard.personal.rune': '个人地图碎片 · 符文井',
  'item.shard.personal.star': '个人地图碎片 · 星辉窟',
  'item.shard.personal.ember': '个人地图碎片 · 余烬坑',
  'item.shard.personal.abyss': '个人地图碎片 · 深渊门',
  'item.shard.team.front': '团队地图碎片 · 联盟前线',
  'item.shard.team.lava': '团队地图碎片 · 熔火矿场',
  'item.shard.team.nexus': '团队地图碎片 · 中枢矿核',
  'item.shard.team.rift': '团队地图碎片 · 深渊矿沟',
  'item.shard.team.sanct': '团队地图碎片 · 圣所矿厅',
  'item.shard.team.storm': '团队地图碎片 · 风暴矿区',
  'item.nft.personal.core': '个人地图 NFT · 命运核',
  'item.nft.personal.neon': '个人地图 NFT · 霓虹洞',
  'item.nft.personal.rune': '个人地图 NFT · 符文井',
  'item.nft.personal.star': '个人地图 NFT · 星辉窟',
  'item.nft.personal.ember': '个人地图 NFT · 余烬坑',
  'item.nft.personal.abyss': '个人地图 NFT · 深渊门',
  'item.nft.team.front': '团队地图 NFT · 联盟前线',
  'item.nft.team.lava': '团队地图 NFT · 熔火矿场',
  'item.nft.team.nexus': '团队地图 NFT · 中枢矿核',
  'item.nft.team.rift': '团队地图 NFT · 深渊矿沟',
  'item.nft.team.sanct': '团队地图 NFT · 圣所矿厅',
  'item.nft.team.storm': '团队地图 NFT · 风暴矿区',
  'member.title': '会员中心',
  'member.non': '非会员',
